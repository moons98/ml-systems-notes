...
### 1.2 Weight-stall + skew streaming
...
- 처음 깊이 분석한 paper: [HeteroInfer (SOSP'25)](../notes/sosp25-heteroinfer.md) — §3 NPU 특성 + §4 GPU-NPU 병렬 디자인 (이 노트의 NPU-1/2/3 분류와 transpose trick의 출처)
